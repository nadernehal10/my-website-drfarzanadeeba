...
const BLOG_POSTS = [

  {
    ...
    imageLabelEn: "IUI treatment guide illustration",
    imageLabelBn: "আইইউআই চিকিৎসা গাইড চিত্র",
    titleEn: "What is IUI? A Complete Guide to Intrauterine Insemination",
    titleBn: "আইইউআই কী? ইন্ট্রাউটেরাইন ইনসেমিনেশনের সম্পূর্ণ গাইড",
    excerptEn: "If you have been told that IUI might help you conceive, this guide explains exactly what the procedure involves, who it is suitable for, and what success rates look like in Bangladesh.",
    excerptBn: "যদি আপনাকে বলা হয়ে থাকে যে আইইউআই গর্ভধারণে সাহায্য করতে পারে, এই গাইডটি প্রক্রিয়াটি ঠিক কী তা ব্যাখ্যা করে।",
    externalUrl: "blog-iui.html",
    bodyEn: "",
    bodyBn: "",
  },

  {
    ...
    imageLabelEn: "PCOS treatment illustration",
    imageLabelBn: "পিসিওএস চিকিৎসা চিত্র",
    titleEn: "PCOS Treatment in Bangladesh: Symptoms, Causes and What to Do Next",
    titleBn: "বাংলাদেশে পিসিওএস চিকিৎসা: লক্ষণ, কারণ এবং পরবর্তী পদক্ষেপ",
    excerptEn: "Polycystic Ovary Syndrome affects 1 in 10 women in Bangladesh. Here is what you need to know about symptoms, treatment, and your fertility options.",
    excerptBn: "পলিসিস্টিক ওভারি সিনড্রোম বাংলাদেশে ১০ জনে ১ জন নারীকে প্রভাবিত করে।",
...

  {
    ...
    readTime: "5 min",
    image: "img/blog-fertility.svg",
    imageLabelEn: "fertility specialist consultation illustration",
    imageLabelBn: "বিশেষজ্ঞ পরামর্শ চিত্র",
    titleEn: "When Should You See an Infertility Specialist in Dhaka?",
    titleBn: "ঢাকায় কখন বন্ধ্যাত্ব বিশেষজ্ঞ দেখাবেন?",
    excerptEn: "Many couples in Bangladesh wait too long before seeking specialist help. This guide explains exactly when to seek a consultation and what to expect at your first visit.",
    excerptBn: "বাংলাদেশে অনেক দম্পতি বিশেষজ্ঞ সাহায্য নেওয়ার আগে অনেক দেরি করে ফেলেন।",
    externalUrl: "blog-when-to-see-specialist.html",
    bodyEn: "",
    bodyBn: "",
  },
