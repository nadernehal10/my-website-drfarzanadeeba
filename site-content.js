...
const BLOG_POSTS = [

  {
    ...
    imageLabelEn: "high-risk pregnancy care illustration",
    imageLabelBn: "উচ্চ ঝুঁকির গর্ভাবস্থা চিত্র",
    titleEn: "High-Risk Pregnancy Care in Dhaka: What It Means and What to Expect",
    titleBn: "ঢাকায় উচ্চ ঝুঁকির গর্ভাবস্থা সেবা: এর অর্থ কী এবং কী আশা করবেন",
    excerptEn: "Being told your pregnancy is high-risk can feel alarming. This guide explains what the classification actually means, what causes it, and how specialist care in Dhaka helps ensure the best possible outcome.",
    excerptBn: "উচ্চ ঝুঁকির গর্ভাবস্থা শোনা উদ্বেগজনক মনে হতে পারে। এই গাইডটি ব্যাখ্যা করে এর অর্থ কী এবং সঠিক বিশেষজ্ঞ সেবা কীভাবে সর্বোত্তম ফলাফল নিশ্চিত করে।",
    externalUrl: "blog-high-risk-pregnancy.html",
    bodyEn: "",
    bodyBn: "",
  },

  {
    ...
    imageLabelEn: "IVF vs IUI comparison illustration",
    imageLabelBn: "আইভিএফ বনাম আইইউআই তুলনা চিত্র",
    titleEn: "IVF vs IUI — What Is the Difference and Which One Is Right for You?",
    titleBn: "আইভিএফ বনাম আইইউআই — পার্থক্য কী এবং আপনার জন্য কোনটি সঠিক?",
    excerptEn: "IUI and IVF are both effective fertility treatments but work very differently. This clear guide explains both procedures so you can have an informed conversation with your specialist.",
    excerptBn: "আইইউআই এবং আইভিএফ উভয়ই কার্যকর উর্বরতা চিকিৎসা কিন্তু খুব আলাদাভাবে কাজ করে।",
    externalUrl: "blog-ivf-vs-iui.html",
    bodyEn: "",
    bodyBn: "",
  },

  {
    id: "laparoscopy-endometriosis",
    category: "surgery",
    featured: false,
    date: "August 2026",
    dateBn: "আগস্ট ২০২৬",
    ...
    imageLabelEn: "laparoscopic surgery endometriosis illustration",
    imageLabelBn: "ল্যাপারোস্কোপিক সার্জারি এন্ডোমেট্রিওসিস চিত্র",
    titleEn: "Laparoscopic Surgery for Endometriosis — A Complete Patient Guide",
    titleBn: "এন্ডোমেট্রিওসিসের জন্য ল্যাপারোস্কোপিক সার্জারি — সম্পূর্ণ রোগী গাইড",
    excerptEn: "Endometriosis is one of the leading causes of pelvic pain and infertility in Bangladesh. Laparoscopic surgery offers both diagnosis and treatment — this guide explains what to expect.",
    excerptBn: "এন্ডোমেট্রিওসিস বাংলাদেশে পেলভিক ব্যথা ও বন্ধ্যাত্বের অন্যতম প্রধান কারণ।",
    externalUrl: "blog-laparoscopy-endometriosis.html",
    bodyEn: "",
    bodyBn: "",
  },
